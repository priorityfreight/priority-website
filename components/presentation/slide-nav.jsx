...
export function SlideNav({ items }) {
  return (
    <aside className="sticky top-4 z-30 hidden h-[calc(100vh-2rem)] w-[240px] shrink-0 rounded-[30px] border border-white/10 bg-[rgba(7,21,44,0.72)] p-5 shadow-[0_30px_80px_rgba(2,8,20,0.34)] backdrop-blur-xl xl:block">
